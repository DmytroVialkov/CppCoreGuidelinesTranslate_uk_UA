...
Цей документ є набором рекомендацій щодо правильного використання C++.
Мета цього документу - допомогти людям ефективно використовувати сучасний C++.
Під "сучасним C++" ми маємо на увазі ефективне використання стандарту ISO C++ (наразі C++20, але майже всі наші рекомендації стосуються також C++17, C++14 та C++11).
Іншими словами, як би ви хотіли, щоб ваш код виглядав через 5 років, враховуючи, що ви можете почати зараз? Через 10 років?

Настанови зосереджені на відносно високорівневих питаннях, таких як інтерфейси, управління ресурсами, управління пам'яттю та паралелізм.
Такі правила впливають на архітектуру додатків та дизайн бібліотек.
Дотримання правил призведе до того, що код буде статично типобезпечним, не матиме витоків ресурсів і ловитиме набагато більше логічних помилок програмування, ніж зазвичай зустрічається в сучасному коді.
І це буде швидко - ви можете дозволити собі робити все правильно.

Нас менше турбують низькорівневі питання, такі як конвенції іменування та стиль відступів.
Однак жодна тема, яка може допомогти програмісту, не є забороненою.

Наш початковий набір правил наголошує на безпеці (у різних формах) і простоті.
Ці правила можуть бути занадто суворими.
Ми очікуємо, що нам доведеться ввести більше винятків, щоб краще відповідати реальним потребам.
Нам також потрібно більше правил.

Деякі правила можуть суперечити вашим очікуванням або навіть суперечити вашому досвіду.
Якщо ми не запропонували вам змінити стиль кодування, значить, ми зазнали невдачі!
Будь ласка, спробуйте підтвердити або спростувати правила!
Зокрема, ми б дуже хотіли, щоб деякі з наших правил були підкріплені вимірами або кращими прикладами.

Деякі правила здадуться вам очевидними або навіть тривіальними.
Будь ласка, пам'ятайте, що одна з цілей настанови - допомогти менш досвідченим або тим, хто походить з іншого середовища чи розмовляє іншою мовою, ввійти в курс справи.

Багато правил розроблено так, щоб їх можна було підтримувати за допомогою інструментів аналізу.
Порушення правил будуть позначені посиланнями (або лінками) на відповідне правило.
Ми не очікуємо, що ви запам'ятаєте всі правила до того, як почнете писати код.
Ви можете розглядати ці правила як специфікацію для інструментів, які можуть бути прочитані людиною.

Правила призначені для поступового впровадження в кодову базу.
Ми плануємо створити інструменти для цього і сподіваємося, що інші теж.

Зауваження та пропозиції щодо покращення вітаються.
Ми плануємо змінювати і розширювати цей документ у міру того, як ми будемо покращувати наше розуміння і вдосконалювати мову та набір доступних бібліотек.
